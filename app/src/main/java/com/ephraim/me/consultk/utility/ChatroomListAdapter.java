...
import com.ephraim.me.consultk.ChatActivity;
import com.ephraim.me.consultk.R;
import com.ephraim.me.consultk.models.Chatroom;
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for(DataSnapshot singleSnapshot:  dataSnapshot.getChildren()){
                        ...
                        ImageLoader.getInstance().displayImage(
                                Objects.requireNonNull(singleSnapshot.getValue(User.class)).getProfile_image() , holder.mProfileImage);
                    }
                }
